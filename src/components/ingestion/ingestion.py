...
class IngestionManager:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            # Save the split data
            self.source.write_flat_file(train_set, path=self.ingestion_config.train_data_path)
            self.source.write_flat_file(test_set, path=self.ingestion_config.test_data_path)
